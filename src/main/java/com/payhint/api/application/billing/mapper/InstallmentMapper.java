...
import com.payhint.api.application.billing.dto.response.InstallmentWithPaymentsResponse;
...
public interface InstallmentMapper {
    ...
    @Named("toInstallmentWithPaymentsResponse")
    InstallmentWithPaymentsResponse toInstallmentWithPaymentsResponse(Installment installment);

    @Named("toInstallmentWithPaymentsResponseList")
    @IterableMapping(qualifiedByName = "toInstallmentWithPaymentsResponse")
    List<InstallmentWithPaymentsResponse> toInstallmentWithPaymentsResponse(List<Installment> installments);
}
